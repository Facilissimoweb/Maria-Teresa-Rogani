    ...
    switch (docType) {
        ...
        return (
          <div className="space-y-6 text-slate-300 text-xs sm:text-sm leading-relaxed text-left font-sans font-light">
            <div className="flex items-center space-x-3 border-b border-white/10 pb-4">
              <Shield className="w-8 h-8 text-[#f4700a]" />
              <div>
            ...
            <div className="space-y-3">
              <h4 className="font-bold text-xs uppercase tracking-wider text-white border-l-2 border-[#f4700a] pl-2 font-mono">1. Titolare del Trattamento</h4>
              <p>
                ...
                Email di contatto: <a href="mailto:facilissimoweb.mc@gmail.com" className="text-[#f4700a] underline">facilissimoweb.mc@gmail.com</a><br />
                Telefono: <strong>+39 379 360 3321</strong>
              </p>
            </div>

            <div className="space-y-3">
              <h4 className="font-bold text-xs uppercase tracking-wider text-white border-l-2 border-[#f4700a] pl-2 font-mono">2. Tipologia di Dati Raccolti</h4>
              <p>
            ...
            <div className="space-y-3">
              <h4 className="font-bold text-xs uppercase tracking-wider text-white border-l-2 border-[#f4700a] pl-2 font-mono">3. Finalità del Trattamento</h4>
              <p>
            ...
            <div className="space-y-3">
              <h4 className="font-bold text-xs uppercase tracking-wider text-white border-l-2 border-[#f4700a] pl-2 font-mono">4. Base Giuridica del Trattamento</h4>
              <p>
            ...
            <div className="space-y-3">
              <h4 className="font-bold text-xs uppercase tracking-wider text-white border-l-2 border-[#f4700a] pl-2 font-mono">5. Conservazione e Sicurezza dei Dati</h4>
              <p>
      ...
      case 'cookie':
        return (
          <div className="space-y-6 text-slate-300 text-xs sm:text-sm leading-relaxed text-left font-sans font-light">
            <div className="flex items-center space-x-3 border-b border-white/10 pb-4">
              <Eye className="w-8 h-8 text-[#f4700a]" />
              <div>
            ...
            <div className="space-y-3">
              <h4 className="font-bold text-xs uppercase tracking-wider text-white border-l-2 border-[#f4700a] pl-2 font-mono">1. Tipologie di Cookie Utilizzati</h4>
            ...
            <div className="space-y-3">
              <h4 className="font-bold text-xs uppercase tracking-wider text-white border-l-2 border-[#f4700a] pl-2 font-mono">2. Consenso ed Abilitazione dei Cookie</h4>
              <p>
            ...
            <div className="space-y-3">
              <h4 className="font-bold text-xs uppercase tracking-wider text-white border-l-2 border-[#f4700a] pl-2 font-mono">3. Come disabilitare i cookie tramite Browser</h4>
              <p>
      ...
      case 'terms':
        return (
          <div className="space-y-6 text-slate-300 text-xs sm:text-sm leading-relaxed text-left font-sans font-light">
            <div className="flex items-center space-x-3 border-b border-white/10 pb-4">
              <FileText className="w-8 h-8 text-[#f4700a]" />
              <div>
            ...
            <div className="space-y-3">
              <h4 className="font-bold text-xs uppercase tracking-wider text-white border-l-2 border-[#f4700a] pl-2 font-mono">1. Oggetto dei Servizi Preliminari</h4>
              <p>
            ...
            <div className="space-y-3">
              <h4 className="font-bold text-xs uppercase tracking-wider text-white border-l-2 border-[#f4700a] pl-2 font-mono">2. Accuratezza delle Informazioni</h4>
              <p>
            ...
            <div className="space-y-3">
              <h4 className="font-bold text-xs uppercase tracking-wider text-white border-l-2 border-[#f4700a] pl-2 font-mono">3. Clausola di Riservatezza ed Etica Professionale</h4>
              <p>
            ...
            <div className="space-y-3">
              <h4 className="font-bold text-xs uppercase tracking-wider text-white border-l-2 border-[#f4700a] pl-2 font-mono">4. Limitazione di Responsabilità</h4>
              <p>
  ...
  return (
    <div id="legal-modal-overlay" className="fixed inset-0 bg-black/80 backdrop-blur-sm z-[999] flex items-center justify-center p-4">
      <div 
        ref={modalBodyRef}
        id="legal-modal-body" 
        className="bg-[#111113] border-2 border-[#f4700a] max-w-2xl w-full max-h-[85vh] overflow-y-auto shadow-2xl relative flex flex-col rounded-none animate-scaleIn"
      >
        {/* Close Button */}
        <button 
          onClick={onClose}
