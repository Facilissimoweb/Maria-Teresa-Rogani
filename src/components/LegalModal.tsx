...
import { X, Shield, Eye, FileText, Download } from 'lucide-react';
...
export default function LegalModal({ isOpen, docType, onClose }: LegalModalProps) {
  ...
  const renderContent = () => {
    switch (docType) {
      case 'privacy':
        return (
          <div className="space-y-6 text-slate-700 dark:text-slate-300 text-xs sm:text-sm leading-relaxed text-left">
            <div className="flex items-center space-x-3 border-b border-slate-100 dark:border-white/10 pb-4">
              ...
              <div>
                <h3 className="text-base sm:text-lg font-bold text-[#0A192F] dark:text-white uppercase tracking-wider">Informativa sulla Privacy Policy</h3>
                <p className="text-[10px] text-slate-400 uppercase tracking-widest">Ai sensi del Regolamento Europeo GDPR 2016/679</p>
              </div>
            </div>
            ...
            <div className="space-y-3">
              <h4 className="font-bold text-xs uppercase tracking-wider text-[#0A192F] dark:text-white border-l-2 border-[#4A90E2] pl-2">1. Titolare del Trattamento</h4>
              <p>
                ...
                Email di contatto: <a href="mailto:facilissimoweb.mc@gmail.com" className="text-[#4A90E2] underline">facilissimoweb.mc@gmail.com</a><br />
                Telefono: <strong>+39 379 360 3321</strong>
              </p>
            </div>

            <div className="space-y-3">
              <h4 className="font-bold text-xs uppercase tracking-wider text-[#0A192F] dark:text-white border-l-2 border-[#4A90E2] pl-2">2. Tipologia di Dati Raccolti</h4>
              <p>
            ...
            <div className="space-y-3">
              <h4 className="font-bold text-xs uppercase tracking-wider text-[#0A192F] dark:text-white border-l-2 border-[#4A90E2] pl-2">3. Finalità del Trattamento</h4>
              <p>
            ...
            <div className="space-y-3">
              <h4 className="font-bold text-xs uppercase tracking-wider text-[#0A192F] dark:text-white border-l-2 border-[#4A90E2] pl-2">4. Base Giuridica del Trattamento</h4>
              <p>
            ...
            <div className="space-y-3">
              <h4 className="font-bold text-xs uppercase tracking-wider text-[#0A192F] dark:text-white border-l-2 border-[#4A90E2] pl-2">5. Conservazione e Sicurezza dei Dati</h4>
              <p>
        ...
        return (
          <div className="space-y-6 text-slate-700 dark:text-slate-300 text-xs sm:text-sm leading-relaxed text-left">
            <div className="flex items-center space-x-3 border-b border-slate-100 dark:border-white/10 pb-4">
              ...
              <div>
                <h3 className="text-base sm:text-lg font-bold text-[#0A192F] dark:text-white uppercase tracking-wider">Informativa Estesa sui Cookie</h3>
                <p className="text-[10px] text-slate-400 uppercase tracking-widest">Provvedimento del Garante della Privacy n. 229/2014 e linee guida GDPR</p>
              </div>
            </div>
            ...
            <div className="space-y-3">
              <h4 className="font-bold text-xs uppercase tracking-wider text-[#0A192F] dark:text-white border-l-2 border-[#4A90E2] pl-2">1. Tipologie di Cookie Utilizzati</h4>
              <ul className="list-disc pl-5 space-y-2">
                <li>
                  <strong>Cookie Tecnici e di Preferenza (Sito):</strong> Necessari per il corretto funzionamento dell'interfaccia utente. Memorizzano informazioni utili quali lo stato del tema scuro (Dark Mode), le preferenze di zoom del testo del pannello di accessibilità, e l'accettazione del cookie banner stesso. Questi cookie non raccolgono informazioni a fini di marketing e non richiedono il preventivo consenso dell'utente, in quanto essenziali per erogare il servizio.
                </li>
                <li>
            ...
            <div className="space-y-3">
              <h4 className="font-bold text-xs uppercase tracking-wider text-[#0A192F] dark:text-white border-l-2 border-[#4A90E2] pl-2">2. Consenso ed Abilitazione dei Cookie</h4>
              <p>
            ...
            <div className="space-y-3">
              <h4 className="font-bold text-xs uppercase tracking-wider text-[#0A192F] dark:text-white border-l-2 border-[#4A90E2] pl-2">3. Come disabilitare i cookie tramite Browser</h4>
              <p>
                Ogni utente può rifiutare o cancellare i cookie modificando manualmente le impostazioni del proprio browser di navigazione (Chrome, Firefox, Edge, Safari, Opera). Si ricorda che la disabilitazione totale dei cookie tecnici potrebbe compromettere la navigazione ottimale di alcune sezioni di FACILISSIMO WEB (es. la memorizzazione della modalità scura o della dimensione del testo).
              </p>
            </div>
          </div>
        );
        ...
        return (
          <div className="space-y-6 text-slate-700 dark:text-slate-300 text-xs sm:text-sm leading-relaxed text-left">
            <div className="flex items-center space-x-3 border-b border-slate-100 dark:border-white/10 pb-4">
              ...
              <div>
                <h3 className="text-base sm:text-lg font-bold text-[#0A192F] dark:text-white uppercase tracking-wider">Termini e Condizioni di Servizio</h3>
                <p className="text-[10px] text-slate-400 uppercase tracking-widest">Accordo contrattuale per le prestazioni di consulenza e sviluppo web</p>
              </div>
            </div>
            ...
            <div className="space-y-3">
              <h4 className="font-bold text-xs uppercase tracking-wider text-[#0A192F] dark:text-white border-l-2 border-[#4A90E2] pl-2">1. Oggetto dei Servizi Preliminari</h4>
              <p>
              ...
              <ul className="list-disc pl-5 space-y-1">
                <li>
                  <strong>Call Preliminare Gratuita (15 Minuti):</strong> Briefing puramente esplorativo volto a inquadrare l'idea generale della piattaforma, utile per valutare la tipologia di sviluppo raccomandata (CMS o Sviluppo Custom React). Non costituisce parere o consulenza professionale vincolante.
                </li>
                <li>
            ...
            <div className="space-y-3">
              <h4 className="font-bold text-xs uppercase tracking-wider text-[#0A192F] dark:text-white border-l-2 border-[#4A90E2] pl-2">2. Accuratezza delle Informazioni</h4>
              <p>
            ...
            <div className="space-y-3">
              <h4 className="font-bold text-xs uppercase tracking-wider text-[#0A192F] dark:text-white border-l-2 border-[#4A90E2] pl-2">3. Clausola di Riservatezza ed Etica Professionale</h4>
              <p>
            ...
            <div className="space-y-3">
              <h4 className="font-bold text-xs uppercase tracking-wider text-[#0A192F] dark:text-white border-l-2 border-[#4A90E2] pl-2">4. Limitazione di Responsabilità</h4>
              <p>
  ...
  return (
    <div id="legal-modal-overlay" className="fixed inset-0 bg-[#0A192F]/80 backdrop-blur-sm z-[999] flex items-center justify-center p-4">
      <div 
        ref={modalBodyRef}
        id="legal-modal-body" 
        className="bg-white dark:bg-[#0d1e36] border-2 border-[#0A192F] dark:border-[#4A90E2] max-w-2xl w-full max-h-[85vh] overflow-y-auto shadow-2xl relative flex flex-col rounded-none animate-scaleIn"
      >
        {/* Close Button */}
        <button 
          onClick={onClose}
          className="absolute top-4 right-4 p-2 text-[#0A192F] dark:text-white hover:bg-slate-100 dark:hover:bg-white/5 transition-colors cursor-pointer"
        ...
        {/* Modal Footer */}
        <div className="border-t border-slate-100 dark:border-white/10 px-6 sm:px-8 py-4 bg-slate-50 dark:bg-[#0a192f] flex justify-end">
          <button 
            onClick={onClose}
            className="px-6 py-2 bg-[#0A192F] dark:bg-[#4A90E2] text-white dark:text-slate-950 text-xs font-bold uppercase tracking-widest hover:opacity-90 transition-opacity cursor-pointer"
          >
            Ho Letto e Compreso
          </button>
        </div>
