        ...
        {loading ? (
          ...
          <div className="max-w-xl mx-auto bg-white dark:bg-[#0c1e36] border-2 border-emerald-500 p-8 text-center space-y-6 shadow-xl rounded-none">
            ...
            <button 
              ...
              style={{ width: '100%' }}
              className="px-6 py-3.5 bg-[#4285F4] hover:bg-[#357AE8] text-white text-xs font-bold uppercase tracking-[0.2em] shadow-lg flex items-center justify-center space-x-3 cursor-pointer transition-colors"
            >
